...
/**
 * This class is used to show all the Gold users on the leaderboard. It receives an ordered list
 * of type LeaderBoardUserDetails, this object contains all the information for the list to be
 * displayed correctly.
 */
public class LeaderboardListAdapter extends BaseAdapter {
    ...
    public LeaderboardListAdapter(ArrayList<LeaderBoardUserDetails> leaderBoardUserDetails,
                                  Context context) {
    ...
    //Setting the values into each of the views, the values are taken from the
    // leaderBoardUserDetails object that was parsed in from the fragment.
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.leaderBoardShareButton =
                    convertView.findViewById(R.id.leaderboard_share_button);
        ...
        viewHolder.leaderBoardShareButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                context.startActivity(new ShareService("Look at where I am on the leader board",
                        "I have completed " + leaderBoardUserDetails.get(position).getScore() +
                                " moves this week. I am in " + (position + 1) +
                                positionPrefix(position + 1) +
                                " place. Can you beat me next week? \n Download the Nimble Fitness Companion app now: https://www-users.york.ac.uk/~hew550/",
                        "Share your position on the leader board - ").ShareContent());
            }
        });
    ...
    //A method to ensure that when converting the users position into text the correct prefix is
    // added
    ...
    //Defining all views on each of the list items
